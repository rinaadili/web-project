<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $created_date2 = $_POST['created_date'];
        ...
        if (empty($created_date2)) {
            $errCreatedDate = "Date is required!";
        }

        if(!empty($title2) && !empty($description2) && !empty($created_date2)){
        ...
        $sql = "UPDATE services SET title = '$title2', description = '$description2', photo = '$photo2', created_date = 
        '$created_date2' WHERE id = '$id'";
...
<body>
    ...
    <div id="mainContent">
        <form id="editServices" method="post" id="editServices" enctype="multipart/form-data" onsubmit ="return validate()">
            <label>Title:</label><br>
            <input type="text" name="title" value="<?php echo $title ?>" placeholder="Enter title" id="title"><br>
            ...
            <label>Date:</label><br>
            <input type="date" name="created_date" value="<?php echo($created_date); ?>"><br>
    ...
    <script type="text/javascript">
        ...
        function validate(){
            var ftitle = document.forms["editServices"]["title"].value;
            var fdescription = document.forms["editServices"]["description"].value;    
            var fcreated_date = document.forms["editServices"]["created_date"].value;
